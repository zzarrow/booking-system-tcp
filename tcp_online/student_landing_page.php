...
//echo('<br /><b>Student Landing Page</b>');

$next_appointment = $tcpdatalink->get_next_student_apt($pennkey);
if($next_appointment != null){
	...
	echo('
		<li>
			<strong>You have an upcoming TCP appointment on ' . $d . ' at ' . $t . '.</strong>
			<li style="margin-left: 8%" type="square"><a href="view_appointment.php?id=' . $next_appointment->get_id() . '">View appointment details</a></li>
			<li style="margin-left: 8%" type="square"><a href="cancel_appointment.php?id=' . $next_appointment->get_id() . '">Cancel appointment</a></li>
		</li>
	');
} 
else
...
<ul> 
  <li class ="noicon current" ><a href="index.php">Home</a></li> 
