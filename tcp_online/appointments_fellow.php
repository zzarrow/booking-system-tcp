	...
	for($i = 0; $i < sizeof($data); $i++){
		...
		echo('
			<ul>
				...
				<li type="square" style="margin-left: 5%">Booking comment: ' . $data[$i]->get_comment() . '</li>
			<br />
			<li><a href="view_appointment.php?id="' . $data[$i]->get_id() . '>View Appointment</a></li>
			</ul>
		');
	}
}
...
<li class ="noicon " ><a href="index.php">Fellow Control Panel Home</a></li> 
  ...
  <li class="noicon "><a href="http://www.seas.upenn.edu/~tcp">&laquo; Back to TCP Site</a></li> </ul> 
<br /> 
